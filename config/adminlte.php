        ...
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/input-mask/jquery.inputmask.js',
                ],
            ],
        ],
        [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/input-mask/jquery.inputmask.date.extensions.js',
                ],
            ],
        ],
        [
            'name' => 'inputmaskextension',
            'active' => true,
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/input-mask/jquery.inputmask.extensions.js',
                ],
            ],
        ],
